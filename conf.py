...
_C.EATA.MARGIN_E0 = 0.4

_C.EATA.FFT_DIM = 6144
_C.EATA.CLUSTER_NUM = 4
_C.EATA.CLUSTER_SIZE = 200
_C.EATA.LOCAL_LR = 0.0005
_C.EATA.COMM_INTERVAL = 10
_C.EATA.KMEANS_SIZE = 256
...
_C.DEYO.AUG_TYPE = "occ"          # Choose from: ['occ', 'patch', 'pixel']
_C.DEYO.OCCLUSION_SIZE = 16        # For aug_type occ
_C.DEYO.ROW_START = 8              # For aug_type occ
_C.DEYO.COLUMN_START = 8           # For aug_type occ
